...
namespace Business.Concrete
{
    public class CarManager : ICarService
    {
        ...
        {
            //aracın model yılının son 20 yıl içinde olup olmadığını kontrol et
        ...
        {   //aracın model yılının son 20 yıl içinde olup olmadığını kontrol et(modeldeki yapı gibi)
            //_carBusinessRules.CheckIfCarModelYearsValid(request.ModelYear);
            //int currentYear = DateTime.Now.Year;
            //if (request.ModelYear < currentYear - 20)
            //{
